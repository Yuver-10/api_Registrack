...
Role.belongsToMany(Permiso, { through: RolPermisoPrivilegio, foreignKey: 'id_rol', otherKey: 'id_permiso', as: 'permisos' });
Permiso.belongsToMany(Role, { through: RolPermisoPrivilegio, foreignKey: 'id_permiso', otherKey: 'id_rol', as: 'roles' });

Role.belongsToMany(Privilegio, { through: RolPermisoPrivilegio, foreignKey: 'id_rol', otherKey: 'id_privilegio', as: 'privilegios' });
Privilegio.belongsToMany(Role, { through: RolPermisoPrivilegio, foreignKey: 'id_privilegio', otherKey: 'id_rol', as: 'roles' });

export { Role, Permiso, Privilegio, RolPermisoPrivilegio };
